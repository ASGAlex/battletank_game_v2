...
import 'package:tank_game/packages/flame_override/lib/src/drag_callbacks.dart';
...
class MultiDragDispatcher extends Component implements MultiDragListener {
  ...
  final Set<DragCallbacks> dragCallbacksComponents = {};
  ...
  void onDragStart(DragStartEvent event) {
    event.deliverAtPointCached(
      supportedComponents: dragCallbacksComponents,
